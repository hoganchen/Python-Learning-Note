...
def get_prime(min_value):
    prime_value = min_value

    if prime_value % 2 == 0:
        prime_value += 1

    while True:
        logging.debug("prime_value: {}".format(prime_value))
        flag = True

        if prime_value > 2 and prime_value % 2 == 0:
            flag = False
        else:
            for i in range(3, int(math.sqrt(prime_value) + 1), 2):
...
def main():
    ...
    print(get_prime(8148143905337944345073782753637512644205873574663745002544561797417525199053346824733589523))
    return
    print(get_prime(2**(random.randint(256, 512)) + 1))
    diffie_hellman(97, 6, 21, 3)
    diffie_hellman(93, 6, 21, 3)
    diffie_hellman(94, 6, 21, 3)
    diffie_hellman(random.randint(0, len(prime_list)), random.randint(5, 100), random.randint(5, 100))
